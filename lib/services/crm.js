 ...
 * @param  {String}   mandateId Mandate ID
 */
CRM.prototype.deleteDirectDebitMandate = function(mandateId, division, callback) {
  if(typeof division === 'function') {
    callback = division;
    division = this.client.division;
  }

  this.client.sendRequest('/v1/' + division + '/cashflow/DirectDebitMandates(guid\'' + mandateId + '\')', 'DELETE', null, userData, callback);
};
